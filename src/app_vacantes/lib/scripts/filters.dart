...
class Filtrado {
  static String localizarRuta(Map<String, dynamic> consulta) {
    ...
    String rutaExcel =
        "assets/model_excel_app.xlsx"; //"$anoPath/$cuerpo/$especialidadPath";
    return rutaExcel;
  }

  static Future<List<Map<String, dynamic>>> obtenerResultados(
      Map<String, dynamic> consulta) async {
    ...
    List<Map<String, dynamic>> obtenerCoincidencias(
        List<Map<String, dynamic>> lista, String clave, dynamic valor) {
    ...
    List<Map<String, dynamic>> obtenerCoincidenciasProvincias(
        List<Map<String, dynamic>> lista, String clave, dynamic valor) {
      List<Map<String, dynamic>> resultados = [];
    ...
    List<Map<String, dynamic>> coincidenciasEspecialidad =
        obtenerCoincidencias(Excel, 'especialidad', especialidad);

    List<Map<String, dynamic>> coincidencias = obtenerCoincidenciasProvincias(
        coincidenciasEspecialidad, 'provincia', provincia);
